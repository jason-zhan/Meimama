...
public class HTTPCommClient {
	 ...
	 private static  String processURL="http://192.168.1.116:8080/MeiMaMa/";  
    ...
    * @param  password 
    */  
   public String loginRemoteService(String cellPhone, String code){  
       String result=null;  
       try {  
           ...
           //远程登录URL  
           if(code.equals("") ){
        	   processURL=processURL+"GetCode.action?userName="+cellPhone; 
           }else{
        	   processURL=processURL+"Register.action?userName="+cellPhone +"&password="+code; 
           }
